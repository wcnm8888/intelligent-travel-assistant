...
目标：B-000、F-001、F-002 和 F-003 已完成；F-004 已按风险拆为 F-004A/F-004B，当前只激活已批准的 F-004A。
...
| 4 | F-004A 单城市 2–7 日计划扩展 | ACTIVE | 用户可生成更长但仍可控、可追溯的单城市行程 | F-003 |
...
- 状态：`ACTIVE`；任务卡已批准，Step 0–1 已完成，等待用户批准 Step 2；
